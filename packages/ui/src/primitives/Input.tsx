  ...
  return (
    <input
      ...
      className={cn(
        ...
        'min-h-11 w-full rounded-[10px] border bg-field px-3 text-base text-content',
        'placeholder:text-content-muted transition-colors duration-fast md:min-h-0 md:py-2 md:text-sm',
